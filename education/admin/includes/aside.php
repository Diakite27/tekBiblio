...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <!-- <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
            <i class="bi bi-menu-button-wide"></i><span>Gestion des étudiants</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="emprunt.php">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="livre.php">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="auteur.php">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="category.php">
            ...
            <span>Gérer les catégories de livre</span>
        </a>
    </li>
    <!-- End F.A.Q Page Nav -->
